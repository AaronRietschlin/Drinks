...
public class DrinksContract {
    ...
    public static class TabGeofenceEntry extends DrinksBaseColumns {
        public static final String RADIUS = "radius";
        public static final String EXPIRATION_TIME = "expiration_time";
        public static final String GEOFENCE_ID = "geofence_id";
        public static final String INTENT_FLAG = "intent_flag";
        public static final String LOITERING_DELAY = "loitering_delay";
        public static final String NOTIFICATION_RESPONSIVENESS = "notification_responsiveness";
    }
