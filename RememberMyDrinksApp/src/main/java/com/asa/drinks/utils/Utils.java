...
public class Utils {
	 ...
	 * 
	 * @param view
	 *            {@link android.view.View#VISIBLE} when {@code true}, {@link android.view.View#GONE} when
	 *            {@code false}.
	 * @param show
	 */
	 ...
	 * @param show
	 * @param goneType
	 *            Pass in either {@link android.view.View#GONE} or {@link android.view.View#INVISIBLE}.
	 *            Throws an exception if you pass {@link android.view.View#VISIBLE}.
	 */
	 ...
	 * 
	 * @param wv
	 *            The WebView to load into.
	 * @param str
	 *            A string of raw HTML content
	 * @param color
	 *            The color to make the content
	 * @param bold
	 *            Tells whether or not to bold the text.
	 */
	@SuppressLint("NewApi")
	...
	// public static boolean isInDatabase(Model model) {
